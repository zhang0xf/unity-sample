...
public class Message
{
    ...
    private byte m_UdpPacketType = (byte)UdpPacketType.MsgNeedAck;
    ...
    public Message(string msgName)
    {
        ...
        m_Size = 0;
        m_Name = msgName;
        Write((Int32)0);    // 服务器端框架源码要求：HeaderSize = 4
        Write(msgName);
    }
    ...
    public byte SetUdpPacketType(UdpPacketType type, bool needAck)
    {
        if (needAck)
        {
